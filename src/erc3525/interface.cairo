...
trait IERC3525<TContractState> {
    ...
    fn balance_of(self: @TContractState, token_id: u256) -> u256;
    fn slot_of(self: @TContractState, token_id: u256) -> u256;
    fn approve_value(ref self: TContractState, token_id: u256, operator: ContractAddress, value: u256);
    fn allowance(self: @TContractState, token_id: u256, operator: ContractAddress) -> u256;
    fn transfer_value_from(ref self: TContractState, from_token_id: u256, to_token_id: u256, to: ContractAddress, value: u256) -> u256;
}

#[starknet::interface]
trait IERC3525Legacy<TContractState> {
    fn valueDecimals(self: @TContractState) -> u8;
    fn balanceOf(self: @TContractState, tokenId: u256) -> u256;
    fn slotOf(self: @TContractState, tokenId: u256) -> u256;
    fn approveValue(ref self: TContractState, tokenId: u256, operator: ContractAddress, value: u256);
